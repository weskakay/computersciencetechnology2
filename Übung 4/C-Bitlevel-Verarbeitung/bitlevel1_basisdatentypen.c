// bitlevel1.c
// Das Programm demonstriert die Manipulation einzelner Bits in einem 8-Bit-Wort (unsigned char)
...
void reset_bit(unsigned char* bits, int pos)
{
	unsigned char mask = 0x01;
	mask = mask<<pos;
...
int isset_bit(unsigned char bits, int pos)
{
...
int main()
{
	...
	unsigned char  bitfield = 0x00;  // Ausgangspunkt: kein Bit ist gesetzt
